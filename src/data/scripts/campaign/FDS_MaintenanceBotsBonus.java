...
import data.scripts.FDS_modPlugin;
...
public class FDS_MaintenanceBotsBonus implements EveryFrameScript {
    ...
    public FDS_MaintenanceBotsBonus() {
    }

    public void advance(float amount) {
        if (FDS_modPlugin.droidMechanics) {
            ...
            if (this.interval.intervalElapsed()) {
                ...
                while(true) {
                    ...
                    while(i$.hasNext()) {
                        FleetMemberAPI member = (FleetMemberAPI)i$.next();
                        BuffManagerAPI.Buff buff = member.getBuffManager().getBuff("fds_maintenanceBotsBonus");
    ...
    private static class FDS_MaintenanceBotsBuff implements BuffManagerAPI.Buff {
